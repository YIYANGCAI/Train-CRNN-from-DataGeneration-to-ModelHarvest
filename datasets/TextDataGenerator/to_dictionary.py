...
def to_dictionary(text_path='newwords.txt', code='utf-8'):
...
if __name__ == '__main__':
	...
	#alp_dict =  {key : value for key, value in enumerate(set(alphabet))}
	#dict.update(alp_dict)
	s = list_char(dict,"mydict.txt",alphabet)
	print(s)
	print(len(s))
	# list_a = [3,4,5,8]
	# list_b = [3,4,5,6,7]
